...
var createNeedElement = function(messageData) {
    ...
    var $editButton = $('<button type="button" class="delete-message"> Edit </button>');
    var $deleteButton = $('<button type="button" class="delete-message"> X </button>');
    var $inputField = $("<input>").val(messageData.content);
    var $userTimeInfo = $("<p>" +formattedTime + " " + ampm + " " + "<span class='username'>" + messageData.username + '</span></p>');
    var $li = $('<li data-id="'+ messageData.id +'" class="message"></li>');
